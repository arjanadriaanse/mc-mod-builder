...
public class BlockChooseInStructureWindow extends JFrame {
	ListPanel listPanel;
	StructureEditor main;
	
	public BlockChooseInStructureWindow(Map<String, ImageIcon> elements,StructureEditor parent){
		this.main = parent;
	...
	public void choose(String block){
		main.chooseBlock(block);
		this.dispose();
	}
